...
public static class HelperMethods
{
    ...
    /// <sumary>
    /// Gets Components of type T at box with center point and size and angle. Return true if at least one found and the found components are returned in the list
    /// <sumary>
